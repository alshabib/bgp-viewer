...
echo ""
echo "SSH: $ssh_pid"
#add on 0415 by linpp
curl -X GET http://127.0.0.1:8090/wm/bgp/rib/192.168.10.101
sleep 2
#end add 0415 by linp
echo ""
...
echo ""
echo "Press any key to del link CHI and AS2"
read value
...
#	echo "Link UP ---- [5]:AS3-LAX;  [6]:CHI-IAH;  [7]:CHI-AS2;  [8]ATL-NYC."
	echo "Link DOWN ---- [4]:NYC-ATL; [3]:LAX-AS3; "
